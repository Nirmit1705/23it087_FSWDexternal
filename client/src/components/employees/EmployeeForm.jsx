      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <form onSubmit={handleSubmit} className="max-w-5xl">
          ...
          <div className="bg-card-bg border border-white/5 rounded-lg p-6 mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                type="button"
                onClick={addSkill}
                className="flex items-center gap-1 text-sm bg-accent-primary/20 hover:bg-accent-primary/30 text-accent-primary py-1 px-3 rounded-md transition-colors"
              >
          ...
          <div className="flex gap-3 justify-end mb-6">
            <Link
              to="/dashboard"
              className="py-2 px-4 bg-bg-secondary hover:bg-bg-secondary/80 text-text-primary rounded-md transition-colors"
            >
              Cancel
            </Link>
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-2 py-2 px-4 bg-accent-primary hover:bg-accent-secondary text-white rounded-md transition-colors"
            >
              <FiSave size={18} />
